                            ...
                            {[
                              ...
                              <div key={f.label} className="space-y-2">
                                ...
                                <div className="aspect-video bg-black rounded-xl border border-white/[0.05] overflow-hidden">
                                  {f.image ? (
                                    <img src={URL.createObjectURL(f.image)} alt={f.label} className="w-full h-full object-cover" />
                                  ) : (
                                ...
                                {f.image && (
                                  <a href={URL.createObjectURL(f.image)} download={f.name}
                    ...
                    {state.sceneProcessing === 'complete' && state.currentPrompt && (
                      <div className="space-y-5">
                        ...
                        <div className="flex gap-4">
                          <button onClick={() => setState(s => ({ ...s, sceneProcessing: 'idle', currentPrompt: null }))}
